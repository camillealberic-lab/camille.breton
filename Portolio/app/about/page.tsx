  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" style={{ paddingTop: NAV_HEIGHT }}>
        ...
        {/* 07 — collé en bas à gauche */}
        <motion.span
          className="absolute left-6 font-geologica font-medium leading-none text-orange select-none"
          style={{
        ...
        {/* Right — info sidebar, décalée vers le centre */}
        <motion.div
          className="absolute right-0 top-0 bottom-0 w-[42%] flex flex-col gap-6 pr-14 pl-4 overflow-y-auto"
        ...
        >
          ...
          <div>
            ...
            <p className="font-montserrat font-normal text-[13.5px] leading-[1.85] text-ink/60">
          ...
          <div>
            ...
            <p className="font-montserrat font-normal text-[13.5px] leading-[1.9] text-ink/60">
          ...
          <div>
            ...
            <a
              ...
              className="font-montserrat font-normal text-[13.5px] text-ink/60 hover:text-ink transition-colors duration-300 relative inline-block"
            >
